...
useEffect(() => {
  async function loadSettings() {
    ...
    try {
      ...
      if (linkedinError) {
        console.error(
          "LinkedIn connection lookup error:",
          linkedinError,
        );
      }
      ...
      if (linkedinStatus === "connected") {
        ...
        /*
         * Remove the OAuth status from the URL
         * after reading it.
         */
      ...
      if (linkedinStatus === "profile_error") {
        setError(
      ...
      if (linkedinStatus === "no_code") {
        setError(
          "LinkedIn authorization did not return a code.",
        );
      }
...
if (!business.target_customers.trim()) {
  setError(
    "Please enter your target customers.",
  );
  return;
}
...
if (!business.marketing_goal.trim()) {
  setError(
    "Please enter your main marketing goal.",
  );
  return;
}
...
if (loading) {
return ( <main className="min-h-screen bg-slate-50 px-6 py-10"> <div className="mx-auto max-w-4xl"> <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm"> <p className="text-sm text-slate-500">
Loading business settings... </p> </div> </div> </main>
);
}

return ( <main className="min-h-screen bg-slate-50 text-slate-950"> <div className="mx-auto max-w-4xl px-6 py-8 lg:px-8"> <div className="mb-8"> <a
         href="/dashboard"
...
← Back to dashboard </a>
      ...
      <p className="mt-2 text-sm leading-6 text-slate-600">
        Manage the business information Adverio
        uses to personalise your AI-generated
        marketing content.
      </p>
    </div>
    ...
    >
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm leading-6 text-slate-500">
          Keep these details accurate so Adverio
          can create relevant and truthful
          marketing content.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-slate-400">
            Describe the services your business
            provides.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-slate-400">
            Example: Get more enquiries, generate
            more bookings, or increase repeat
            customers.
          </p>
        </div>
      </div>
