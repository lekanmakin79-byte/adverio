  ...
  useEffect(() => {
    async function loadSettings() {
      ...
      try {
         ...
         * --------------------------------------------------
         *
         * The selected business is determined server-side
         * by the secure selected-business cookie.
         */
        ...
        if (!businessResponse.ok || !businessResult.business) {
          window.location.href = "/onboarding";
          return;
        }

        const data = businessResult.business as Business;
